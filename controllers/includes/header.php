    ...
    <header class="header black-bg">
        ...
        <div class="top-menu">
            <ul class="nav pull-right top-menu">
                <li><a class="logout" href="<?php echo app_path?>controllers/logout.php">Logout</a></li>
            </ul>
        </div>
    </header>
    <!--header end-->
            ...
            <ul class="sidebar-menu" id="nav-accordion"> 
                <p class="centered">
                    <a href="account.php">
                        <p class="centered">
                            <a href="account.php"> 
                                <img src='images/profile/<?php echo getPhoto($accountPhoto); ?>' class="img-circle" width="100">
                            </a>
                        </p>
                    </a>
                </p>
